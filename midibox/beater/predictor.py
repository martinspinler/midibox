...
class NoteOffsetPrediction:
    ...
    dbg_all_p: list[tuple[NotePrediction, BeatPhase]]
    dbg_state: str = ""
...
class TempoPredictor:
    ...
    def predict_note(self, e, beat_exp, beat_len, beat_phase):
        ...
        if self._debug:
            ...
            p.dbg_state = (f"{e:.3f} {beat_phase:.2f} {beat_len:.3f} | {bl:.3f} {cnt: 3d} | {ed: 5.3f} {edi: 5.3f} {edn: 5.3f} {edni: 5.3f} | {cnt: 3d} {state} . {err:0.3f}")
        return p
